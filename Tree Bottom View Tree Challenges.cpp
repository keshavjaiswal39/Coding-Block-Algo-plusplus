...
void topview(Node* root)
{
    ...
    */
    ...
    while(q.size())
	{
        ...
        // Har baar root ka index update hote rahega, ek hi index par jyaada elements ho sakta hai
        // toh iss case mein, woh data replace hote rahega and mao mein jo last element insert hga kisi bhi 
        // specific index pe , wohi answer hga uce index kiliye bottom view
        m[index]=root->data;
